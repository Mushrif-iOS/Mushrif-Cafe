...
//        let strMessage = message!
    ...
    class func showAlertWithOkButton(controller: AnyObject,
                                     ...
                                     completion: ((Int, String) -> Void)?)
    {
        showAlert(controller: controller, message: message, style: .alert, cancelButton: nil, distrutiveButton: nil, otherButtons: ["ok".localized()], completion: completion)
    }
    ...
    class func showAlertWithCancelButton(controller: AnyObject,
                                         ...
                                         completion: ((Int, String) -> Void)?)
    {
        showAlert(controller: controller, message: message, style: .alert, cancelButton: "cancel".localized(), distrutiveButton: nil, otherButtons: nil, completion: completion)
    }
    ...
    class func showDeleteAlert(controller: AnyObject,
                               ...
                               completion: ((Int, String) -> Void)?)
    {
        showAlert(controller: controller, message: message, style: .alert, cancelButton: "cancel".localized(), distrutiveButton: "delete".localized(), otherButtons: nil, completion: completion)
    }
    ...
    class func showActionsheetForImagePicker(controller: AnyObject,
                                             ...
                                             completion: ((Int, String) -> Void)?)
    {
        showAlert(controller: controller, message: message, style: .actionSheet, cancelButton: "cancel".localized(), distrutiveButton: nil, otherButtons: ["Use Gallery", "Use Camera"], completion: completion)
    }
}
